...
#ifndef TUNDRA_DYNAMICARRAYBTType_H
#define TUNDRA_DYNAMICARRAYBTType_H
...
#define TUNDRA_TYPE BuiltinType
#define TUNDRA_TYPENAME BTType
...
#endif // TUNDRA_DYNAMICARRAYBTType_H
