...
#ifndef TUNDRA_DYNAMICARRAYExprPtr_H
#define TUNDRA_DYNAMICARRAYExprPtr_H
...
#define TUNDRA_TYPE Expression*
#define TUNDRA_TYPENAME ExprPtr
...
#endif // TUNDRA_DYNAMICARRAYExprPtr_H
