...
#ifndef TUNDRA_DYNAMICARRAYStrVw_H
#define TUNDRA_DYNAMICARRAYStrVw_H
...
#define TUNDRA_TYPE Tundra_StringView
#define TUNDRA_TYPENAME StrVw
...
#endif // TUNDRA_DYNAMICARRAYStrVw_H
